...
public class AmplReplanControllerProxyTest {
    ...
    public void testAddDependenciesOfFeatureByIdOfProjectById_sd668() throws Exception {
        ...
        assertEquals(222, feature.getCode());
    }
    ...
    public void testAddDependenciesOfFeatureByIdOfProjectById_sd672() throws Exception {
        ...
        Feature feature = AmplReplanControllerProxyTest.proxy.addDependenciesOfFeatureByIdOfProjectById(dependencies, features.get(1).getId(), projectId);
        Assert.notNull(feature);
        assertEquals(4, feature.getPriority());
    }
    ...
    public void testAddDependenciesOfFeatureByIdOfProjectById_sd673() throws Exception {
        ...
        Feature feature = AmplReplanControllerProxyTest.proxy.addDependenciesOfFeatureByIdOfProjectById(dependencies, features.get(1).getId(), projectId);
        Assert.notNull(feature);
        assertEquals(1, feature.getReleaseId());
    }
    ...
    public void testAddSkillsOfFeatureByIdOfProjectById_sd5104() throws Exception {
        ...
        Assert.notNull(feature);
        assertEquals(111, feature.getCode());
    }
    ...
    @Test(timeout = 10000)
    public void testAddSkillsOfFeatureByIdOfProjectById_sd5106() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(projectId);
        ...
        assertTrue(o_testAddSkillsOfFeatureByIdOfProjectById_sd5106__13.isEmpty());
    }
    ...
    public void testAddSkillsOfFeatureByIdOfProjectById_sd5108() throws Exception {
        ...
        Feature feature = AmplReplanControllerProxyTest.proxy.addSkillsOfFeatureByIdOfProjectById(skills, features.get(0).getId(), projectId);
        Assert.notNull(feature);
        assertEquals(5, feature.getPriority());
    }
    ...
    @Test(timeout = 10000)
    public void testAddSkillsOfFeatureByIdOfProjectById_sd5105_sd5278() throws Exception {
        ...
        Assert.notNull(feature);
        Date o_testAddSkillsOfFeatureByIdOfProjectById_sd5105__13 = feature.getDeadline();
        List<Feature> o_testAddSkillsOfFeatureByIdOfProjectById_sd5105_sd5278__17 = feature.getDependencies();
        assertTrue(o_testAddSkillsOfFeatureByIdOfProjectById_sd5105_sd5278__17.isEmpty());
    }

    @Test(timeout = 10000)
    public void testAddSkillsOfFeatureByIdOfProjectById_sd5105_sd5281() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
    ...
    @Test(timeout = 10000)
    public void testAddSkillsOfFeatureByIdOfProjectById_sd5104_sd5249() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        ...
        Assert.notNull(feature);
        Integer o_testAddSkillsOfFeatureByIdOfProjectById_sd5104__13 = feature.getCode();
        List<Feature> o_testAddSkillsOfFeatureByIdOfProjectById_sd5104_sd5249__17 = feature.getDependencies();
        assertTrue(o_testAddSkillsOfFeatureByIdOfProjectById_sd5104_sd5249__17.isEmpty());
    }
    ...
    @Test(timeout = 10000)
    public void testAddSkillsOfFeatureByIdOfProjectById_sd5108_sd5340() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
    ...
    @Test(timeout = 10000)
    public void testAddSkillsOfFeatureByIdOfProjectById_sd5108_sd5337() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        ...
        Assert.notNull(feature);
        Integer o_testAddSkillsOfFeatureByIdOfProjectById_sd5108__13 = feature.getPriority();
        List<Feature> o_testAddSkillsOfFeatureByIdOfProjectById_sd5108_sd5337__17 = feature.getDependencies();
        assertTrue(o_testAddSkillsOfFeatureByIdOfProjectById_sd5108_sd5337__17.isEmpty());
    }

    @Test(timeout = 10000)
    public void testAddSkillsOfFeatureByIdOfProjectById_sd5109_sd5366() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        ...
        Assert.notNull(feature);
        Integer o_testAddSkillsOfFeatureByIdOfProjectById_sd5109__13 = feature.getReleaseId();
        List<Feature> o_testAddSkillsOfFeatureByIdOfProjectById_sd5109_sd5366__17 = feature.getDependencies();
        assertTrue(o_testAddSkillsOfFeatureByIdOfProjectById_sd5109_sd5366__17.isEmpty());
    }
    ...
    @Test(timeout = 10000)
    public void testAddSkillsOfFeatureByIdOfProjectById_sd5105_add5275_sd6095() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        ...
        Date o_testAddSkillsOfFeatureByIdOfProjectById_sd5105_add5275__13 = feature.getDeadline();
        Date o_testAddSkillsOfFeatureByIdOfProjectById_sd5105__13 = feature.getDeadline();
        List<Feature> o_testAddSkillsOfFeatureByIdOfProjectById_sd5105_add5275_sd6095__21 = feature.getDependencies();
        assertTrue(o_testAddSkillsOfFeatureByIdOfProjectById_sd5105_add5275_sd6095__21.isEmpty());
    }

    @Test(timeout = 10000)
    public void testAddSkillsOfFeatureByIdOfProjectById_sd5105_add5275_sd6098() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
    ...
    @Test(timeout = 10000)
    public void testAddSkillsOfFeatureByIdOfProjectById_sd5105_sd5281_sd6063() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        ...
        Assert.notNull(feature);
        Date o_testAddSkillsOfFeatureByIdOfProjectById_sd5105__13 = feature.getDeadline();
        Integer o_testAddSkillsOfFeatureByIdOfProjectById_sd5105_sd5281__17 = feature.getReleaseId();
        assertEquals(111, feature.getCode());
    }
    ...
    @Test(timeout = 10000)
    public void testAddSkillsOfFeatureByIdOfProjectById_sd5104_sd5247_sd6185() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        ...
        Integer o_testAddSkillsOfFeatureByIdOfProjectById_sd5104__13 = feature.getCode();
        Integer o_testAddSkillsOfFeatureByIdOfProjectById_sd5104_sd5247__17 = feature.getCode();
        List<Feature> o_testAddSkillsOfFeatureByIdOfProjectById_sd5104_sd5247_sd6185__21 = feature.getDependencies();
        assertTrue(o_testAddSkillsOfFeatureByIdOfProjectById_sd5104_sd5247_sd6185__21.isEmpty());
    }
    ...
    @Test(timeout = 10000)
    public void testAddSkillsOfFeatureByIdOfProjectById_sd5105_sd5276_sd6155() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        ...
        Assert.notNull(feature);
        Date o_testAddSkillsOfFeatureByIdOfProjectById_sd5105__13 = feature.getDeadline();
        Integer o_testAddSkillsOfFeatureByIdOfProjectById_sd5105_sd5276__17 = feature.getCode();
        List<Feature> o_testAddSkillsOfFeatureByIdOfProjectById_sd5105_sd5276_sd6155__21 = feature.getDependencies();
        assertTrue(o_testAddSkillsOfFeatureByIdOfProjectById_sd5105_sd5276_sd6155__21.isEmpty());
    }

    @Test(timeout = 10000)
    public void testAddSkillsOfFeatureByIdOfProjectById_sd5105_sd5280_sd6128() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
    ...
    @Test(timeout = 10000)
    public void testAddSkillsOfFeatureByIdOfProjectById_sd5104_sd5251_sd6275() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        ...
        Integer o_testAddSkillsOfFeatureByIdOfProjectById_sd5104__13 = feature.getCode();
        Integer o_testAddSkillsOfFeatureByIdOfProjectById_sd5104_sd5251__17 = feature.getPriority();
        List<Feature> o_testAddSkillsOfFeatureByIdOfProjectById_sd5104_sd5251_sd6275__21 = feature.getDependencies();
        assertTrue(o_testAddSkillsOfFeatureByIdOfProjectById_sd5104_sd5251_sd6275__21.isEmpty());
    }

    @Test(timeout = 10000)
    public void testAddSkillsOfFeatureByIdOfProjectById_sd5105_sd5280_sd6125() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        ...
        Date o_testAddSkillsOfFeatureByIdOfProjectById_sd5105__13 = feature.getDeadline();
        Integer o_testAddSkillsOfFeatureByIdOfProjectById_sd5105_sd5280__17 = feature.getPriority();
        List<Feature> o_testAddSkillsOfFeatureByIdOfProjectById_sd5105_sd5280_sd6125__21 = feature.getDependencies();
        assertTrue(o_testAddSkillsOfFeatureByIdOfProjectById_sd5105_sd5280_sd6125__21.isEmpty());
    }

    @Test(timeout = 10000)
    public void testAddSkillsOfFeatureByIdOfProjectById_sd5105_sd5281_sd6065() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        ...
        Date o_testAddSkillsOfFeatureByIdOfProjectById_sd5105__13 = feature.getDeadline();
        Integer o_testAddSkillsOfFeatureByIdOfProjectById_sd5105_sd5281__17 = feature.getReleaseId();
        List<Feature> o_testAddSkillsOfFeatureByIdOfProjectById_sd5105_sd5281_sd6065__21 = feature.getDependencies();
        assertTrue(o_testAddSkillsOfFeatureByIdOfProjectById_sd5105_sd5281_sd6065__21.isEmpty());
    }

    @Test(timeout = 10000)
    public void testAddSkillsOfFeatureByIdOfProjectById_sd5109_sd5364_sd6245() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        ...
        Assert.notNull(feature);
        Integer o_testAddSkillsOfFeatureByIdOfProjectById_sd5109__13 = feature.getReleaseId();
        Integer o_testAddSkillsOfFeatureByIdOfProjectById_sd5109_sd5364__17 = feature.getCode();
        List<Feature> o_testAddSkillsOfFeatureByIdOfProjectById_sd5109_sd5364_sd6245__21 = feature.getDependencies();
        assertTrue(o_testAddSkillsOfFeatureByIdOfProjectById_sd5109_sd5364_sd6245__21.isEmpty());
    }

    @Test(timeout = 10000)
    public void testAddSkillsOfFeatureByIdOfProjectById_sd5108_sd5340_add6365() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        Assert.notEmpty(features);
        Integer o_testAddSkillsOfFeatureByIdOfProjectById_sd5108_sd5340_add6365__8 = features.get(0).getId();
        assertEquals(1, ((int) (o_testAddSkillsOfFeatureByIdOfProjectById_sd5108_sd5340_add6365__8)));
        Feature feature = AmplReplanControllerProxyTest.proxy.addSkillsOfFeatureByIdOfProjectById(skills, features.get(0).getId(), this.projectId);
        Assert.notNull(feature);
        Integer o_testAddSkillsOfFeatureByIdOfProjectById_sd5108__13 = feature.getPriority();
    ...
    @Test(timeout = 10000)
    public void testAddSkillsOfFeatureByIdOfProjectById_sd5108_sd5340_sd6372() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        ...
        Integer o_testAddSkillsOfFeatureByIdOfProjectById_sd5108__13 = feature.getPriority();
        Integer o_testAddSkillsOfFeatureByIdOfProjectById_sd5108_sd5340__17 = feature.getReleaseId();
        List<Feature> o_testAddSkillsOfFeatureByIdOfProjectById_sd5108_sd5340_sd6372__21 = feature.getDependencies();
        assertTrue(o_testAddSkillsOfFeatureByIdOfProjectById_sd5108_sd5340_sd6372__21.isEmpty());
    }
    ...
    @Test(timeout = 10000)
    public void testAddSkillsOfResourceByIdOfProjectById_add7249() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Resource> resources = AmplReplanControllerProxyTest.proxy.getResourcesOfProjectById(projectId);
        ...
        Assert.notEmpty(resources);
        List<Skill> skillsToAdd = new ArrayList<>();
        Skill o_testAddSkillsOfResourceByIdOfProjectById_add7249__11 = skills.get(0);
        assertEquals("Java", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testAddSkillsOfResourceByIdOfProjectById_add7249__11).getName());
        assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Skill)o_testAddSkillsOfResourceByIdOfProjectById_add7249__11).getId())));
        assertEquals("Java Programming Language modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testAddSkillsOfResourceByIdOfProjectById_add7249__11).getDescription());
        boolean o_testAddSkillsOfResourceByIdOfProjectById_add7249__12 = skillsToAdd.add(skills.get(0));
        assertTrue(o_testAddSkillsOfResourceByIdOfProjectById_add7249__12);
        Assert.notNull(AmplReplanControllerProxyTest.proxy.addSkillOfResourceByIdOfProjectById(skillsToAdd, resources.get(0).getId(), projectId));
    }
    ...
    @Test(timeout = 10000)
    public void testAddSkillsOfResourceByIdOfProjectById_add7243_add7346() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(projectId);
        Assert.notNull(skills);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        ...
        Assert.notEmpty(resources);
        List<Skill> skillsToAdd = new ArrayList<>();
        Skill o_testAddSkillsOfResourceByIdOfProjectById_add7243_add7346__12 = skills.get(0);
        assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Skill)o_testAddSkillsOfResourceByIdOfProjectById_add7243_add7346__12).getId())));
        assertEquals("Java Programming Language modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testAddSkillsOfResourceByIdOfProjectById_add7243_add7346__12).getDescription());
        assertEquals("Java", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testAddSkillsOfResourceByIdOfProjectById_add7243_add7346__12).getName());
        boolean o_testAddSkillsOfResourceByIdOfProjectById_add7243__12 = skillsToAdd.add(skills.get(0));
        Assert.notNull(AmplReplanControllerProxyTest.proxy.addSkillOfResourceByIdOfProjectById(skillsToAdd, resources.get(0).getId(), projectId));
    }
    ...
    @Test(timeout = 10000)
    public void testAddSkillsOfResourceByIdOfProjectById_add7243_add7345_add7652() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(projectId);
        Assert.notNull(skills);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        ...
        Assert.notEmpty(resources);
        List<Skill> skillsToAdd = new ArrayList<>();
        Skill o_testAddSkillsOfResourceByIdOfProjectById_add7243_add7345_add7652__12 = skills.get(0);
        assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Skill)o_testAddSkillsOfResourceByIdOfProjectById_add7243_add7345_add7652__12).getId())));
        assertEquals("Java Programming Language modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testAddSkillsOfResourceByIdOfProjectById_add7243_add7345_add7652__12).getDescription());
        assertEquals("Java", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testAddSkillsOfResourceByIdOfProjectById_add7243_add7345_add7652__12).getName());
        boolean o_testAddSkillsOfResourceByIdOfProjectById_add7243_add7345__12 = skillsToAdd.add(skills.get(0));
        boolean o_testAddSkillsOfResourceByIdOfProjectById_add7243__12 = skillsToAdd.add(skills.get(0));
        Assert.notNull(AmplReplanControllerProxyTest.proxy.addSkillOfResourceByIdOfProjectById(skillsToAdd, resources.get(0).getId(), projectId));
    }
    ...
    @Test(timeout = 10000)
    public void testCancelLastPlanOfReleaseByIdOfProjectById_sd7988() throws Exception {
        List<Release> releases = AmplReplanControllerProxyTest.proxy.getReleasesOfProjectById(projectId);
        Assert.notEmpty(releases);
        Plan plan = AmplReplanControllerProxyTest.proxy.getPlanOfReleaseByIdOfProjectById(releases.get(0).getId(), projectId);
        Assert.notNull(plan);
        Assert.isTrue(AmplReplanControllerProxyTest.proxy.cancelLastPlanOfReleaseByIdOfProjectById(releases.get(0).getId(), projectId));
        assertEquals(2, plan.getNumberFeatures());
    }
    ...
    public void testCancelLastPlanOfReleaseByIdOfProjectById_sd7989() throws Exception {
        ...
        Assert.notNull(plan);
        Assert.isTrue(AmplReplanControllerProxyTest.proxy.cancelLastPlanOfReleaseByIdOfProjectById(releases.get(0).getId(), projectId));
        assertEquals(0, plan.getNumberJobs());
    }
    ...
    public void testCancelLastPlanOfReleaseByIdOfProjectById_sd7990() throws Exception {
        ...
        Assert.notNull(plan);
        Assert.isTrue(AmplReplanControllerProxyTest.proxy.cancelLastPlanOfReleaseByIdOfProjectById(releases.get(0).getId(), projectId));
        assertEquals(1, plan.getReleaseId());
    }
    ...
    public void testCancelLastPlanOfReleaseByIdOfProjectById_sd7987_literalMutationNumber8203_failAssert19_add8999() throws Exception {
        try {
            ...
            assertEquals(1, releases.get(0).getId());
            Plan plan = AmplReplanControllerProxyTest.proxy.getPlanOfReleaseByIdOfProjectById(releases.get(0).getId(), this.projectId);
            Assert.notNull(plan);
            Boolean result = AmplReplanControllerProxyTest.proxy.cancelLastPlanOfReleaseByIdOfProjectById(releases.get(-1).getId(), this.projectId);
            Assert.isTrue(AmplReplanControllerProxyTest.proxy.cancelLastPlanOfReleaseByIdOfProjectById(releases.get(-1).getId(), this.projectId));
    ...
    @Test(timeout = 10000)
    public void testDelecteSkillsOfResourceByIdOfProjectById_add11924() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(projectId);
        Assert.notNull(skills);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        ...
        Assert.notEmpty(resources);
        List<Skill> skillsToAdd = new ArrayList<>();
        boolean o_testDelecteSkillsOfResourceByIdOfProjectById_add11924__12 = skillsToAdd.add(skills.get(0));
        assertTrue(o_testDelecteSkillsOfResourceByIdOfProjectById_add11924__12);
        Resource resource = AmplReplanControllerProxyTest.proxy.addSkillOfResourceByIdOfProjectById(skillsToAdd, resources.get(0).getId(), projectId);
        Assert.notNull(resource);
        boolean o_testDelecteSkillsOfResourceByIdOfProjectById_add11924__21 = new ArrayList<>().add(skills.get(0));
        assertTrue(o_testDelecteSkillsOfResourceByIdOfProjectById_add11924__21);
    ...
    @Test(timeout = 10000)
    public void testDelecteSkillsOfResourceByIdOfProjectById_add11929() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Resource> resources = AmplReplanControllerProxyTest.proxy.getResourcesOfProjectById(projectId);
        ...
        Assert.notEmpty(resources);
        List<Skill> skillsToAdd = new ArrayList<>();
        boolean o_testDelecteSkillsOfResourceByIdOfProjectById_add11929__11 = skillsToAdd.add(skills.get(0));
        assertTrue(o_testDelecteSkillsOfResourceByIdOfProjectById_add11929__11);
        boolean o_testDelecteSkillsOfResourceByIdOfProjectById_add11929__13 = skillsToAdd.add(skills.get(0));
        assertTrue(o_testDelecteSkillsOfResourceByIdOfProjectById_add11929__13);
        Resource resource = AmplReplanControllerProxyTest.proxy.addSkillOfResourceByIdOfProjectById(skillsToAdd, resources.get(0).getId(), projectId);
        Assert.notNull(resource);
        boolean o_testDelecteSkillsOfResourceByIdOfProjectById_add11929__22 = new ArrayList<>().add(skills.get(0));
        assertTrue(o_testDelecteSkillsOfResourceByIdOfProjectById_add11929__22);
        resource = AmplReplanControllerProxyTest.proxy.deleteSkillsOfResourceByIdOfProjectById(skillsToAdd, resource.getId(), projectId);
        Assert.notNull(resource);
        Assert.isTrue(((resource.getSkills().size()) == ((resource.getSkills().size()) - 1)));
    }
    ...
    @Test(timeout = 10000)
    public void testDelecteSkillsOfResourceByIdOfProjectById_add11930() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Resource> resources = AmplReplanControllerProxyTest.proxy.getResourcesOfProjectById(projectId);
        ...
        Assert.notEmpty(resources);
        List<Skill> skillsToAdd = new ArrayList<>();
        Skill o_testDelecteSkillsOfResourceByIdOfProjectById_add11930__11 = skills.get(0);
        assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Skill)o_testDelecteSkillsOfResourceByIdOfProjectById_add11930__11).getId())));
        assertEquals("Java Programming Language modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDelecteSkillsOfResourceByIdOfProjectById_add11930__11).getDescription());
        assertEquals("Java", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDelecteSkillsOfResourceByIdOfProjectById_add11930__11).getName());
        boolean o_testDelecteSkillsOfResourceByIdOfProjectById_add11930__12 = skillsToAdd.add(skills.get(0));
        assertTrue(o_testDelecteSkillsOfResourceByIdOfProjectById_add11930__12);
        Resource resource = AmplReplanControllerProxyTest.proxy.addSkillOfResourceByIdOfProjectById(skillsToAdd, resources.get(0).getId(), projectId);
        Assert.notNull(resource);
        boolean o_testDelecteSkillsOfResourceByIdOfProjectById_add11930__21 = new ArrayList<>().add(skills.get(0));
        assertTrue(o_testDelecteSkillsOfResourceByIdOfProjectById_add11930__21);
        resource = AmplReplanControllerProxyTest.proxy.deleteSkillsOfResourceByIdOfProjectById(skillsToAdd, resource.getId(), projectId);
        Assert.notNull(resource);
        Assert.isTrue(((resource.getSkills().size()) == ((resource.getSkills().size()) - 1)));
    }
    ...
    @Test(timeout = 10000)
    public void testDelecteSkillsOfResourceByIdOfProjectById_add11930_add12199() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Resource> resources = AmplReplanControllerProxyTest.proxy.getResourcesOfProjectById(this.projectId);
        ...
        Assert.notNull(resource);
        List<Skill> skillsToDelete = new ArrayList<>();
        boolean o_testDelecteSkillsOfResourceByIdOfProjectById_add11930_add12199__25 = skillsToDelete.add(skills.get(0));
        assertTrue(o_testDelecteSkillsOfResourceByIdOfProjectById_add11930_add12199__25);
        boolean o_testDelecteSkillsOfResourceByIdOfProjectById_add11930__21 = skillsToDelete.add(skills.get(0));
    ...
    @Test(timeout = 10000)
    public void testDelecteSkillsOfResourceByIdOfProjectById_add11930_add12193() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Resource> resources = AmplReplanControllerProxyTest.proxy.getResourcesOfProjectById(this.projectId);
        ...
        List<Skill> skillsToAdd = new ArrayList<>();
        Skill o_testDelecteSkillsOfResourceByIdOfProjectById_add11930__11 = skills.get(0);
        boolean o_testDelecteSkillsOfResourceByIdOfProjectById_add11930_add12193__14 = skillsToAdd.add(skills.get(0));
        assertTrue(o_testDelecteSkillsOfResourceByIdOfProjectById_add11930_add12193__14);
        boolean o_testDelecteSkillsOfResourceByIdOfProjectById_add11930__12 = skillsToAdd.add(skills.get(0));
        Resource resource = AmplReplanControllerProxyTest.proxy.addSkillOfResourceByIdOfProjectById(skillsToAdd, resources.get(0).getId(), this.projectId);
        Assert.notNull(resource);
        boolean o_testDelecteSkillsOfResourceByIdOfProjectById_add11930__21 = new ArrayList<>().add(skills.get(0));
    ...
    @Test(timeout = 10000)
    public void testDelecteSkillsOfResourceByIdOfProjectById_add11930_add12194() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Resource> resources = AmplReplanControllerProxyTest.proxy.getResourcesOfProjectById(this.projectId);
        ...
        List<Skill> skillsToAdd = new ArrayList<>();
        Skill o_testDelecteSkillsOfResourceByIdOfProjectById_add11930__11 = skills.get(0);
        Skill o_testDelecteSkillsOfResourceByIdOfProjectById_add11930_add12194__14 = skills.get(0);
        assertEquals("Java Programming Language modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDelecteSkillsOfResourceByIdOfProjectById_add11930_add12194__14).getDescription());
        assertEquals("Java", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDelecteSkillsOfResourceByIdOfProjectById_add11930_add12194__14).getName());
        assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Skill)o_testDelecteSkillsOfResourceByIdOfProjectById_add11930_add12194__14).getId())));
        boolean o_testDelecteSkillsOfResourceByIdOfProjectById_add11930__12 = skillsToAdd.add(skills.get(0));
        Resource resource = AmplReplanControllerProxyTest.proxy.addSkillOfResourceByIdOfProjectById(skillsToAdd, resources.get(0).getId(), this.projectId);
        Assert.notNull(resource);
        boolean o_testDelecteSkillsOfResourceByIdOfProjectById_add11930__21 = new ArrayList<>().add(skills.get(0));
    ...
    @Test(timeout = 10000)
    public void testDelecteSkillsOfResourceByIdOfProjectById_literalMutationNumber11960_failAssert2_add12291() throws Exception {
        try {
            List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
            Assert.notNull(skills);
            Assert.notEmpty(skills);
            ...
            Assert.notEmpty(resources);
            List<Skill> skillsToAdd = new ArrayList<>();
            Skill o_testDelecteSkillsOfResourceByIdOfProjectById_literalMutationNumber11960_failAssert2_add12291__13 = skills.get(0);
            assertEquals("Java", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDelecteSkillsOfResourceByIdOfProjectById_literalMutationNumber11960_failAssert2_add12291__13).getName());
            assertEquals("Java Programming Language modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDelecteSkillsOfResourceByIdOfProjectById_literalMutationNumber11960_failAssert2_add12291__13).getDescription());
            assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Skill)o_testDelecteSkillsOfResourceByIdOfProjectById_literalMutationNumber11960_failAssert2_add12291__13).getId())));
            boolean o_testDelecteSkillsOfResourceByIdOfProjectById_literalMutationNumber11960_failAssert2_add12291__14 = skillsToAdd.add(skills.get(0));
            assertTrue(o_testDelecteSkillsOfResourceByIdOfProjectById_literalMutationNumber11960_failAssert2_add12291__14);
            Resource resource = AmplReplanControllerProxyTest.proxy.addSkillOfResourceByIdOfProjectById(skillsToAdd, resources.get(0).getId(), this.projectId);
            Assert.notNull(resource);
            List<Skill> skillsToDelete = new ArrayList<>();
            new ArrayList<>().add(skills.get(-1));
    ...
    @Test(timeout = 10000)
    public void testDelecteSkillsOfResourceByIdOfProjectById_add11929_add12140() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Resource> resources = AmplReplanControllerProxyTest.proxy.getResourcesOfProjectById(this.projectId);
        ...
        Assert.notEmpty(resources);
        List<Skill> skillsToAdd = new ArrayList<>();
        Skill o_testDelecteSkillsOfResourceByIdOfProjectById_add11929_add12140__11 = skills.get(0);
        assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Skill)o_testDelecteSkillsOfResourceByIdOfProjectById_add11929_add12140__11).getId())));
        assertEquals("Java", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDelecteSkillsOfResourceByIdOfProjectById_add11929_add12140__11).getName());
        assertEquals("Java Programming Language modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDelecteSkillsOfResourceByIdOfProjectById_add11929_add12140__11).getDescription());
        boolean o_testDelecteSkillsOfResourceByIdOfProjectById_add11929__11 = skillsToAdd.add(skills.get(0));
        boolean o_testDelecteSkillsOfResourceByIdOfProjectById_add11929__13 = skillsToAdd.add(skills.get(0));
        Resource resource = AmplReplanControllerProxyTest.proxy.addSkillOfResourceByIdOfProjectById(skillsToAdd, resources.get(0).getId(), this.projectId);
        Assert.notNull(resource);
    ...
    @Test(timeout = 10000)
    public void testDelecteSkillsOfResourceByIdOfProjectById_add11930_add12194_add13038() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Resource> resources = AmplReplanControllerProxyTest.proxy.getResourcesOfProjectById(this.projectId);
        ...
        Assert.notNull(resource);
        List<Skill> skillsToDelete = new ArrayList<>();
        boolean o_testDelecteSkillsOfResourceByIdOfProjectById_add11930_add12194_add13038__28 = skillsToDelete.add(skills.get(0));
        assertTrue(o_testDelecteSkillsOfResourceByIdOfProjectById_add11930_add12194_add13038__28);
        boolean o_testDelecteSkillsOfResourceByIdOfProjectById_add11930__21 = skillsToDelete.add(skills.get(0));
        resource = AmplReplanControllerProxyTest.proxy.deleteSkillsOfResourceByIdOfProjectById(skillsToAdd, resource.getId(), this.projectId);
        Assert.notNull(resource);
        Assert.isTrue(((resource.getSkills().size()) == ((resource.getSkills().size()) - 1)));
    ...
    @Test(timeout = 10000)
    public void testDelecteSkillsOfResourceByIdOfProjectById_add11930_add12194_add13032() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Resource> resources = AmplReplanControllerProxyTest.proxy.getResourcesOfProjectById(this.projectId);
        ...
        Skill o_testDelecteSkillsOfResourceByIdOfProjectById_add11930__11 = skills.get(0);
        Skill o_testDelecteSkillsOfResourceByIdOfProjectById_add11930_add12194__14 = skills.get(0);
        boolean o_testDelecteSkillsOfResourceByIdOfProjectById_add11930_add12194_add13032__17 = skillsToAdd.add(skills.get(0));
        assertTrue(o_testDelecteSkillsOfResourceByIdOfProjectById_add11930_add12194_add13032__17);
        boolean o_testDelecteSkillsOfResourceByIdOfProjectById_add11930__12 = skillsToAdd.add(skills.get(0));
        Resource resource = AmplReplanControllerProxyTest.proxy.addSkillOfResourceByIdOfProjectById(skillsToAdd, resources.get(0).getId(), this.projectId);
        Assert.notNull(resource);
        boolean o_testDelecteSkillsOfResourceByIdOfProjectById_add11930__21 = new ArrayList<>().add(skills.get(0));
    ...
    @Test(timeout = 10000)
    public void testDelecteSkillsOfResourceByIdOfProjectById_add11930_add12194_add13039() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Resource> resources = AmplReplanControllerProxyTest.proxy.getResourcesOfProjectById(this.projectId);
        ...
        Resource resource = AmplReplanControllerProxyTest.proxy.addSkillOfResourceByIdOfProjectById(skillsToAdd, resources.get(0).getId(), this.projectId);
        Assert.notNull(resource);
        Skill o_testDelecteSkillsOfResourceByIdOfProjectById_add11930_add12194_add13039__28 = skills.get(0);
        assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Skill)o_testDelecteSkillsOfResourceByIdOfProjectById_add11930_add12194_add13039__28).getId())));
        assertEquals("Java", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDelecteSkillsOfResourceByIdOfProjectById_add11930_add12194_add13039__28).getName());
        assertEquals("Java Programming Language modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDelecteSkillsOfResourceByIdOfProjectById_add11930_add12194_add13039__28).getDescription());
        boolean o_testDelecteSkillsOfResourceByIdOfProjectById_add11930__21 = new ArrayList<>().add(skills.get(0));
        resource = AmplReplanControllerProxyTest.proxy.deleteSkillsOfResourceByIdOfProjectById(skillsToAdd, resource.getId(), this.projectId);
        Assert.notNull(resource);
        Assert.isTrue(((resource.getSkills().size()) == ((resource.getSkills().size()) - 1)));
    ...
    @Test(timeout = 10000)
    public void testDelecteSkillsOfResourceByIdOfProjectById_add11929_add12140_add13248() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Resource> resources = AmplReplanControllerProxyTest.proxy.getResourcesOfProjectById(this.projectId);
        ...
        Resource resource = AmplReplanControllerProxyTest.proxy.addSkillOfResourceByIdOfProjectById(skillsToAdd, resources.get(0).getId(), this.projectId);
        Assert.notNull(resource);
        Skill o_testDelecteSkillsOfResourceByIdOfProjectById_add11929_add12140_add13248__29 = skills.get(0);
        assertEquals("Java Programming Language modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDelecteSkillsOfResourceByIdOfProjectById_add11929_add12140_add13248__29).getDescription());
        assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Skill)o_testDelecteSkillsOfResourceByIdOfProjectById_add11929_add12140_add13248__29).getId())));
        assertEquals("Java", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDelecteSkillsOfResourceByIdOfProjectById_add11929_add12140_add13248__29).getName());
        boolean o_testDelecteSkillsOfResourceByIdOfProjectById_add11929__22 = new ArrayList<>().add(skills.get(0));
        resource = AmplReplanControllerProxyTest.proxy.deleteSkillsOfResourceByIdOfProjectById(skillsToAdd, resource.getId(), this.projectId);
        Assert.notNull(resource);
        Assert.isTrue(((resource.getSkills().size()) == ((resource.getSkills().size()) - 1)));
    ...
    @Test(timeout = 10000)
    public void testDelecteSkillsOfResourceByIdOfProjectById_literalMutationNumber11960_failAssert2_add12297_add13141() throws Exception {
        try {
            List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
            Assert.notNull(skills);
            Assert.notEmpty(skills);
            ...
            Assert.notEmpty(resources);
            List<Skill> skillsToAdd = new ArrayList<>();
            Skill o_testDelecteSkillsOfResourceByIdOfProjectById_literalMutationNumber11960_failAssert2_add12297_add13141__13 = skills.get(0);
            assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Skill)o_testDelecteSkillsOfResourceByIdOfProjectById_literalMutationNumber11960_failAssert2_add12297_add13141__13).getId())));
            assertEquals("Java Programming Language modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDelecteSkillsOfResourceByIdOfProjectById_literalMutationNumber11960_failAssert2_add12297_add13141__13).getDescription());
            assertEquals("Java", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDelecteSkillsOfResourceByIdOfProjectById_literalMutationNumber11960_failAssert2_add12297_add13141__13).getName());
            boolean o_testDelecteSkillsOfResourceByIdOfProjectById_literalMutationNumber11960_failAssert2_add12297__13 = skillsToAdd.add(skills.get(0));
            Resource resource = AmplReplanControllerProxyTest.proxy.addSkillOfResourceByIdOfProjectById(skillsToAdd, resources.get(0).getId(), this.projectId);
            Assert.notNull(resource);
            List<Skill> skillsToDelete = new ArrayList<>();
    ...
    @Test(timeout = 10000)
    public void testDelecteSkillsOfResourceByIdOfProjectById_literalMutationNumber11960_failAssert2_literalMutationNumber12316_add13193() throws Exception {
        try {
            List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
            Assert.notNull(skills);
            Assert.notEmpty(skills);
            ...
            Assert.notEmpty(resources);
            List<Skill> skillsToAdd = new ArrayList<>();
            Skill o_testDelecteSkillsOfResourceByIdOfProjectById_literalMutationNumber11960_failAssert2_literalMutationNumber12316_add13193__13 = skills.get(0);
            assertEquals("Java Programming Language modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDelecteSkillsOfResourceByIdOfProjectById_literalMutationNumber11960_failAssert2_literalMutationNumber12316_add13193__13).getDescription());
            assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Skill)o_testDelecteSkillsOfResourceByIdOfProjectById_literalMutationNumber11960_failAssert2_literalMutationNumber12316_add13193__13).getId())));
            assertEquals("Java", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDelecteSkillsOfResourceByIdOfProjectById_literalMutationNumber11960_failAssert2_literalMutationNumber12316_add13193__13).getName());
            boolean o_testDelecteSkillsOfResourceByIdOfProjectById_literalMutationNumber11960_failAssert2_literalMutationNumber12316__13 = skillsToAdd.add(skills.get(0));
            Resource resource = AmplReplanControllerProxyTest.proxy.addSkillOfResourceByIdOfProjectById(skillsToAdd, resources.get(-1).getId(), this.projectId);
            Assert.notNull(resource);
            List<Skill> skillsToDelete = new ArrayList<>();
    ...
    @Test(timeout = 10000)
    public void testDelecteSkillsOfResourceByIdOfProjectById_add11930_add12194_literalMutationNumber13068_failAssert0() throws Exception {
        try {
            List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
            Assert.notNull(skills);
            Assert.notEmpty(skills);
            ...
            Assert.notNull(resource);
            Assert.isTrue(((resource.getSkills().size()) == ((resource.getSkills().size()) - 1)));
            org.junit.Assert.fail("testDelecteSkillsOfResourceByIdOfProjectById_add11930_add12194_literalMutationNumber13068 should have thrown ArrayIndexOutOfBoundsException");
        } catch (ArrayIndexOutOfBoundsException eee) {
        }
    }
    ...
    @Test(timeout = 10000)
    public void testDeleteDependenciesOfFeatureByIdOfProjectById_sd13883() throws Exception {
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(projectId);
        Assert.notNull(features);
        Assert.notEmpty(features);
        Assert.isTrue(((features.size()) >= 2));
        List<Feature> dependenciesToAdd = new ArrayList<>();
        boolean o_testDeleteDependenciesOfFeatureByIdOfProjectById_sd13883__9 = dependenciesToAdd.add(features.get(1));
        assertTrue(o_testDeleteDependenciesOfFeatureByIdOfProjectById_sd13883__9);
        Feature feature = AmplReplanControllerProxyTest.proxy.addDependenciesOfFeatureByIdOfProjectById(dependenciesToAdd, features.get(0).getId(), projectId);
        Assert.notNull(feature);
        List<Feature> dependenciesToDelete = new ArrayList<>();
        boolean o_testDeleteDependenciesOfFeatureByIdOfProjectById_sd13883__18 = dependenciesToDelete.add(features.get(1));
        assertTrue(o_testDeleteDependenciesOfFeatureByIdOfProjectById_sd13883__18);
        feature = AmplReplanControllerProxyTest.proxy.deleteDependenciesOfFeatureByIdOfProjectById(dependenciesToDelete, feature.getId(), projectId);
        Assert.notNull(feature);
        List<Feature> o_testDeleteDependenciesOfFeatureByIdOfProjectById_sd13883__24 = feature.getDependencies();
        assertTrue(o_testDeleteDependenciesOfFeatureByIdOfProjectById_sd13883__24.isEmpty());
    }
    ...
    @Test(timeout = 10000)
    public void testDeleteDependenciesOfFeatureByIdOfProjectById_sd13882_sd14226() throws Exception {
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        Assert.notNull(features);
        Assert.notEmpty(features);
        Assert.isTrue(((features.size()) >= 2));
    ...
    @Test(timeout = 10000)
    public void testDeleteDependenciesOfFeatureByIdOfProjectById_add13866_sd14067() throws Exception {
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        Assert.notNull(features);
        Assert.notNull(features);
        Assert.notEmpty(features);
    ...
    @Test(timeout = 10000)
    public void testDeleteDependenciesOfFeatureByIdOfProjectById_add13866_sd14064() throws Exception {
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        Assert.notNull(features);
        Assert.notNull(features);
        Assert.notEmpty(features);
        ...
        assertTrue(o_testDeleteDependenciesOfFeatureByIdOfProjectById_add13866_sd14064__29.isEmpty());
    }
    ...
    @Test(timeout = 10000)
    public void testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942() throws Exception {
        List<Resource> resources = AmplReplanControllerProxyTest.proxy.getResourcesOfProjectById(projectId);
        Assert.notNull(resources);
        Assert.notEmpty(resources);
        List<Release> releases = AmplReplanControllerProxyTest.proxy.getReleasesOfProjectById(projectId);
        ...
        assertEquals("Bla, bla, bla modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942__15).getDescription());
        assertEquals(1480460400L, ((long) (((java.time.Instant)((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942__15).getDeadline()).toInstant()).getEpochSecond())));
        assertEquals(10, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942__15).getDeadline()).getMonth())));
        assertEquals("Nov 30, 2016 12:00:00 AM", ((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942__15).getDeadline()).toLocaleString());
        assertEquals(1480460400000L, ((long) (((java.time.Instant)((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942__15).getDeadline()).toInstant()).toEpochMilli())));
        assertEquals("November Release", ((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942__15).getName());
        assertEquals(0, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942__15).getDeadline()).getSeconds())));
        assertEquals(0, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942__15).getDeadline()).getMinutes())));
        assertEquals(-60, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942__15).getDeadline()).getTimezoneOffset())));
        assertEquals(0, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942__15).getDeadline()).getHours())));
        assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942__15).getId())));
        assertEquals(30, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942__15).getDeadline()).getDate())));
        assertFalse(((java.util.ArrayList)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942__15).getResources()).isEmpty());
        assertEquals(0, ((int) (((java.time.Instant)((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942__15).getDeadline()).toInstant()).getNano())));
        assertEquals(1480460400000L, ((long) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942__15).getDeadline()).getTime())));
        assertEquals(3, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942__15).getDeadline()).getDay())));
        assertEquals(116, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942__15).getDeadline()).getYear())));
        assertEquals("29 Nov 2016 23:00:00 GMT", ((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942__15).getDeadline()).toGMTString());
        Release release = AmplReplanControllerProxyTest.proxy.addResourcesOfReleaseByIdOfProjectById(resourcesToAdd, releases.get(0).getId(), projectId);
        Assert.notNull(release);
        List<Resource> resourcesToDelete = new ArrayList<>();
        boolean o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776__20 = resourcesToDelete.add(resources.get(0));
    ...
    @Test(timeout = 10000)
    public void testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985() throws Exception {
        List<Resource> resources = AmplReplanControllerProxyTest.proxy.getResourcesOfProjectById(projectId);
        Assert.notNull(resources);
        Assert.notEmpty(resources);
        List<Release> releases = AmplReplanControllerProxyTest.proxy.getReleasesOfProjectById(projectId);
        ...
        List<Resource> resourcesToAdd = new ArrayList<>();
        boolean o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781__11 = resourcesToAdd.add(resources.get(0));
        Release o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985__15 = releases.get(0);
        assertEquals(1480460400L, ((long) (((java.time.Instant)((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985__15).getDeadline()).toInstant()).getEpochSecond())));
        assertEquals(0, ((int) (((java.time.Instant)((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985__15).getDeadline()).toInstant()).getNano())));
        assertEquals("Nov 30, 2016 12:00:00 AM", ((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985__15).getDeadline()).toLocaleString());
        assertEquals(10, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985__15).getDeadline()).getMonth())));
        assertEquals(-60, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985__15).getDeadline()).getTimezoneOffset())));
        assertEquals(0, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985__15).getDeadline()).getSeconds())));
        assertFalse(((java.util.ArrayList)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985__15).getResources()).isEmpty());
        assertEquals(3, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985__15).getDeadline()).getDay())));
        assertEquals(1480460400000L, ((long) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985__15).getDeadline()).getTime())));
        assertEquals(0, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985__15).getDeadline()).getMinutes())));
        assertEquals(30, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985__15).getDeadline()).getDate())));
        assertEquals("Bla, bla, bla modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985__15).getDescription());
        assertEquals(1480460400000L, ((long) (((java.time.Instant)((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985__15).getDeadline()).toInstant()).toEpochMilli())));
        assertEquals("November Release", ((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985__15).getName());
        assertEquals(0, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985__15).getDeadline()).getHours())));
        assertEquals("29 Nov 2016 23:00:00 GMT", ((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985__15).getDeadline()).toGMTString());
        assertEquals(116, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985__15).getDeadline()).getYear())));
        assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985__15).getId())));
        Release release = AmplReplanControllerProxyTest.proxy.addResourcesOfReleaseByIdOfProjectById(resourcesToAdd, releases.get(0).getId(), projectId);
        Assert.notNull(release);
        List<Resource> resourcesToDelete = new ArrayList<>();
        boolean o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781__20 = resourcesToDelete.add(resources.get(0));
    ...
    @Test(timeout = 10000)
    public void testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19058() throws Exception {
        try {
            List<Resource> resources = AmplReplanControllerProxyTest.proxy.getResourcesOfProjectById(this.projectId);
            Assert.notNull(resources);
            Assert.notEmpty(resources);
            ...
            Assert.notEmpty(releases);
            List<Resource> resourcesToAdd = new ArrayList<>();
            boolean o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19058__13 = resourcesToAdd.add(resources.get(0));
            assertTrue(o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19058__13);
            Release o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19058__15 = releases.get(0);
            assertEquals(10, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19058__15).getDeadline()).getMonth())));
            assertFalse(((java.util.ArrayList)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19058__15).getResources()).isEmpty());
            assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19058__15).getId())));
            assertEquals(30, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19058__15).getDeadline()).getDate())));
            assertEquals(-60, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19058__15).getDeadline()).getTimezoneOffset())));
            assertEquals("November Release", ((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19058__15).getName());
            assertEquals(3, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19058__15).getDeadline()).getDay())));
            assertEquals("Nov 30, 2016 12:00:00 AM", ((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19058__15).getDeadline()).toLocaleString());
            assertEquals(0, ((int) (((java.time.Instant)((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19058__15).getDeadline()).toInstant()).getNano())));
            assertEquals(1480460400L, ((long) (((java.time.Instant)((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19058__15).getDeadline()).toInstant()).getEpochSecond())));
            assertEquals(1480460400000L, ((long) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19058__15).getDeadline()).getTime())));
            assertEquals("Bla, bla, bla modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19058__15).getDescription());
            assertEquals(0, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19058__15).getDeadline()).getHours())));
            assertEquals(0, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19058__15).getDeadline()).getMinutes())));
            assertEquals("29 Nov 2016 23:00:00 GMT", ((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19058__15).getDeadline()).toGMTString());
            assertEquals(0, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19058__15).getDeadline()).getSeconds())));
            assertEquals(1480460400000L, ((long) (((java.time.Instant)((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19058__15).getDeadline()).toInstant()).toEpochMilli())));
            assertEquals(116, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19058__15).getDeadline()).getYear())));
            Release release = AmplReplanControllerProxyTest.proxy.addResourcesOfReleaseByIdOfProjectById(resourcesToAdd, releases.get(0).getId(), this.projectId);
            Assert.notNull(release);
            List<Resource> resourcesToDelete = new ArrayList<>();
            resourcesToDelete.add(resources.get(-1));
    ...
    @Test(timeout = 10000)
    public void testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985_sd19818() throws Exception {
        List<Resource> resources = AmplReplanControllerProxyTest.proxy.getResourcesOfProjectById(this.projectId);
        Assert.notNull(resources);
        Assert.notEmpty(resources);
        List<Release> releases = AmplReplanControllerProxyTest.proxy.getReleasesOfProjectById(this.projectId);
        ...
        Assert.notNull(release);
        Date o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781__26 = release.getDeadline();
        Date o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985_sd19818__37 = releases.get(0).getDeadline();
        assertEquals(0, ((int) (((java.util.Date)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985_sd19818__37).getSeconds())));
        assertEquals(30, ((int) (((java.util.Date)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985_sd19818__37).getDate())));
        assertEquals(116, ((int) (((java.util.Date)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985_sd19818__37).getYear())));
        assertEquals("29 Nov 2016 23:00:00 GMT", ((java.util.Date)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985_sd19818__37).toGMTString());
        assertEquals(0, ((int) (((java.util.Date)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985_sd19818__37).getHours())));
        assertEquals(1480460400L, ((long) (((java.time.Instant)((java.util.Date)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985_sd19818__37).toInstant()).getEpochSecond())));
        assertEquals(10, ((int) (((java.util.Date)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985_sd19818__37).getMonth())));
        assertEquals(-60, ((int) (((java.util.Date)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985_sd19818__37).getTimezoneOffset())));
        assertEquals(0, ((int) (((java.time.Instant)((java.util.Date)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985_sd19818__37).toInstant()).getNano())));
        assertEquals(3, ((int) (((java.util.Date)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985_sd19818__37).getDay())));
        assertEquals(1480460400000L, ((long) (((java.util.Date)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985_sd19818__37).getTime())));
        assertEquals(0, ((int) (((java.util.Date)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985_sd19818__37).getMinutes())));
        assertEquals("Nov 30, 2016 12:00:00 AM", ((java.util.Date)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985_sd19818__37).toLocaleString());
        assertEquals(1480460400000L, ((long) (((java.time.Instant)((java.util.Date)o_testDeleteResourcesOfReleaseByIdOfProjectById_sd18781_add18985_sd19818__37).toInstant()).toEpochMilli())));
    }

    @Test(timeout = 10000)
    public void testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942_add19710() throws Exception {
        List<Resource> resources = AmplReplanControllerProxyTest.proxy.getResourcesOfProjectById(this.projectId);
        Assert.notNull(resources);
        Assert.notEmpty(resources);
        List<Release> releases = AmplReplanControllerProxyTest.proxy.getReleasesOfProjectById(this.projectId);
        ...
        List<Resource> resourcesToAdd = new ArrayList<>();
        boolean o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776__11 = resourcesToAdd.add(resources.get(0));
        Release o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942_add19710__15 = releases.get(0);
        assertEquals(0, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942_add19710__15).getDeadline()).getHours())));
        assertFalse(((java.util.ArrayList)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942_add19710__15).getResources()).isEmpty());
        assertEquals(1480460400000L, ((long) (((java.time.Instant)((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942_add19710__15).getDeadline()).toInstant()).toEpochMilli())));
        assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942_add19710__15).getId())));
        assertEquals(1480460400L, ((long) (((java.time.Instant)((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942_add19710__15).getDeadline()).toInstant()).getEpochSecond())));
        assertEquals(0, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942_add19710__15).getDeadline()).getSeconds())));
        assertEquals(0, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942_add19710__15).getDeadline()).getMinutes())));
        assertEquals("Bla, bla, bla modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942_add19710__15).getDescription());
        assertEquals("Nov 30, 2016 12:00:00 AM", ((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942_add19710__15).getDeadline()).toLocaleString());
        assertEquals("29 Nov 2016 23:00:00 GMT", ((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942_add19710__15).getDeadline()).toGMTString());
        assertEquals(3, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942_add19710__15).getDeadline()).getDay())));
        assertEquals(116, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942_add19710__15).getDeadline()).getYear())));
        assertEquals(10, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942_add19710__15).getDeadline()).getMonth())));
        assertEquals(1480460400000L, ((long) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942_add19710__15).getDeadline()).getTime())));
        assertEquals("November Release", ((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942_add19710__15).getName());
        assertEquals(-60, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942_add19710__15).getDeadline()).getTimezoneOffset())));
        assertEquals(30, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942_add19710__15).getDeadline()).getDate())));
        assertEquals(0, ((int) (((java.time.Instant)((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942_add19710__15).getDeadline()).toInstant()).getNano())));
        Release o_testDeleteResourcesOfReleaseByIdOfProjectById_add18776_add18942__15 = releases.get(0);
        Release release = AmplReplanControllerProxyTest.proxy.addResourcesOfReleaseByIdOfProjectById(resourcesToAdd, releases.get(0).getId(), this.projectId);
        Assert.notNull(release);
        List<Resource> resourcesToDelete = new ArrayList<>();
    ...
    @Test(timeout = 10000)
    public void testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19049_add19857() throws Exception {
        try {
            List<Resource> resources = AmplReplanControllerProxyTest.proxy.getResourcesOfProjectById(this.projectId);
            Assert.notNull(resources);
            Assert.notNull(resources);
            ...
            List<Resource> resourcesToAdd = new ArrayList<>();
            boolean o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19049__14 = resourcesToAdd.add(resources.get(0));
            Release o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19049_add19857__18 = releases.get(0);
            assertFalse(((java.util.ArrayList)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19049_add19857__18).getResources()).isEmpty());
            assertEquals(3, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19049_add19857__18).getDeadline()).getDay())));
            assertEquals(0, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19049_add19857__18).getDeadline()).getMinutes())));
            assertEquals(0, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19049_add19857__18).getDeadline()).getSeconds())));
            assertEquals(30, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19049_add19857__18).getDeadline()).getDate())));
            assertEquals(-60, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19049_add19857__18).getDeadline()).getTimezoneOffset())));
            assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19049_add19857__18).getId())));
            assertEquals(0, ((int) (((java.time.Instant)((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19049_add19857__18).getDeadline()).toInstant()).getNano())));
            assertEquals(0, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19049_add19857__18).getDeadline()).getHours())));
            assertEquals(1480460400000L, ((long) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19049_add19857__18).getDeadline()).getTime())));
            assertEquals(1480460400L, ((long) (((java.time.Instant)((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19049_add19857__18).getDeadline()).toInstant()).getEpochSecond())));
            assertEquals("Bla, bla, bla modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19049_add19857__18).getDescription());
            assertEquals("29 Nov 2016 23:00:00 GMT", ((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19049_add19857__18).getDeadline()).toGMTString());
            assertEquals(116, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19049_add19857__18).getDeadline()).getYear())));
            assertEquals("Nov 30, 2016 12:00:00 AM", ((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19049_add19857__18).getDeadline()).toLocaleString());
            assertEquals(10, ((int) (((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19049_add19857__18).getDeadline()).getMonth())));
            assertEquals(1480460400000L, ((long) (((java.time.Instant)((java.util.Date)((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19049_add19857__18).getDeadline()).toInstant()).toEpochMilli())));
            assertEquals("November Release", ((eu.supersede.integration.api.replan.controller.types.Release)o_testDeleteResourcesOfReleaseByIdOfProjectById_literalMutationNumber18796_failAssert3_add19049_add19857__18).getName());
            Release release = AmplReplanControllerProxyTest.proxy.addResourcesOfReleaseByIdOfProjectById(resourcesToAdd, releases.get(0).getId(), this.projectId);
            Assert.notNull(release);
            List<Resource> resourcesToDelete = new ArrayList<>();
            resourcesToDelete.add(resources.get(-1));
    ...
    @Test(timeout = 10000)
    public void testDeleteSkillsOfFeatureByIdOfProjectById_add21056() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(projectId);
        ...
        assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_add21056__16).getId())));
        assertEquals("Java", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_add21056__16).getName());
        assertEquals("Java Programming Language modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_add21056__16).getDescription());
        boolean o_testDeleteSkillsOfFeatureByIdOfProjectById_add21056__17 = skillsToDelete.add(skills.get(0));
        assertTrue(o_testDeleteSkillsOfFeatureByIdOfProjectById_add21056__17);
        feature = AmplReplanControllerProxyTest.proxy.deleteSkillsOfFeatureByIdOfProjectById(skillsToDelete, feature.getId(), projectId);
        Assert.notNull(feature);
    }
    ...
    @Test(timeout = 10000)
    public void testDeleteSkillsOfFeatureByIdOfProjectById_add21056_add21284() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        ...
        assertEquals("Java Programming Language modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_add21056_add21284__19).getDescription());
        assertEquals("Java", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_add21056_add21284__19).getName());
        assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_add21056_add21284__19).getId())));
        boolean o_testDeleteSkillsOfFeatureByIdOfProjectById_add21056__17 = skillsToDelete.add(skills.get(0));
        feature = AmplReplanControllerProxyTest.proxy.deleteSkillsOfFeatureByIdOfProjectById(skillsToDelete, feature.getId(), this.projectId);
        Assert.notNull(feature);
    }
    ...
    public void testDeleteSkillsOfFeatureByIdOfProjectById_literalMutationNumber21080_failAssert2_add21556() throws Exception {
        try {
            ...
            assertEquals(1, features.get(0).getId());
            Feature feature = AmplReplanControllerProxyTest.proxy.addSkillsOfFeatureByIdOfProjectById(skills, features.get(0).getId(), this.projectId);
            Assert.notNull(feature);
            List<Skill> skillsToDelete = new ArrayList<>();
            skillsToDelete.add(skills.get(-1));
    ...
    @Test(timeout = 10000)
    public void testDeleteSkillsOfFeatureByIdOfProjectById_sd21065_add21444() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        ...
        assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21065_add21444__16).getId())));
        assertEquals("Java", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21065_add21444__16).getName());
        assertEquals("Java Programming Language modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21065_add21444__16).getDescription());
        boolean o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21065__16 = skillsToDelete.add(skills.get(0));
        feature = AmplReplanControllerProxyTest.proxy.deleteSkillsOfFeatureByIdOfProjectById(skillsToDelete, feature.getId(), this.projectId);
        Assert.notNull(feature);
        Integer o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21065__22 = feature.getReleaseId();
    ...
    @Test(timeout = 10000)
    public void testDeleteSkillsOfFeatureByIdOfProjectById_sd21060_add21327() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        ...
        assertEquals("Java", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21060_add21327__16).getName());
        assertEquals("Java Programming Language modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21060_add21327__16).getDescription());
        assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21060_add21327__16).getId())));
        boolean o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21060__16 = skillsToDelete.add(skills.get(0));
        feature = AmplReplanControllerProxyTest.proxy.deleteSkillsOfFeatureByIdOfProjectById(skillsToDelete, feature.getId(), this.projectId);
        Assert.notNull(feature);
    ...
    @Test(timeout = 10000)
    public void testDeleteSkillsOfFeatureByIdOfProjectById_sd21064_add21405() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        ...
        assertEquals("Java", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21064_add21405__16).getName());
        assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21064_add21405__16).getId())));
        assertEquals("Java Programming Language modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21064_add21405__16).getDescription());
        boolean o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21064__16 = skillsToDelete.add(skills.get(0));
        feature = AmplReplanControllerProxyTest.proxy.deleteSkillsOfFeatureByIdOfProjectById(skillsToDelete, feature.getId(), this.projectId);
        Assert.notNull(feature);
    ...
    @Test(timeout = 10000)
    public void testDeleteSkillsOfFeatureByIdOfProjectById_add21056_add21284_add22467() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        ...
        Skill o_testDeleteSkillsOfFeatureByIdOfProjectById_add21056__16 = skills.get(0);
        Skill o_testDeleteSkillsOfFeatureByIdOfProjectById_add21056_add21284__19 = skills.get(0);
        Skill o_testDeleteSkillsOfFeatureByIdOfProjectById_add21056_add21284_add22467__22 = skills.get(0);
        assertEquals("Java", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_add21056_add21284_add22467__22).getName());
        assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_add21056_add21284_add22467__22).getId())));
        assertEquals("Java Programming Language modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_add21056_add21284_add22467__22).getDescription());
        boolean o_testDeleteSkillsOfFeatureByIdOfProjectById_add21056__17 = skillsToDelete.add(skills.get(0));
        feature = AmplReplanControllerProxyTest.proxy.deleteSkillsOfFeatureByIdOfProjectById(skillsToDelete, feature.getId(), this.projectId);
        Assert.notNull(feature);
    }
    ...
    @Test(timeout = 10000)
    public void testDeleteSkillsOfFeatureByIdOfProjectById_sd21060_add21327_add22645() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        ...
        List<Skill> skillsToDelete = new ArrayList<>();
        Skill o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21060_add21327__16 = skills.get(0);
        boolean o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21060_add21327_add22645__19 = skillsToDelete.add(skills.get(0));
        assertTrue(o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21060_add21327_add22645__19);
        boolean o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21060__16 = skillsToDelete.add(skills.get(0));
        feature = AmplReplanControllerProxyTest.proxy.deleteSkillsOfFeatureByIdOfProjectById(skillsToDelete, feature.getId(), this.projectId);
        Assert.notNull(feature);
        Integer o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21060__22 = feature.getCode();
    ...
    @Test(timeout = 10000)
    public void testDeleteSkillsOfFeatureByIdOfProjectById_sd21065_add21444_add22559() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        ...
        Assert.notNull(feature);
        List<Skill> skillsToDelete = new ArrayList<>();
        Skill o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21065_add21444_add22559__16 = skills.get(0);
        assertEquals("Java", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21065_add21444_add22559__16).getName());
        assertEquals("Java Programming Language modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21065_add21444_add22559__16).getDescription());
        assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21065_add21444_add22559__16).getId())));
        Skill o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21065_add21444__16 = skills.get(0);
        boolean o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21065__16 = skillsToDelete.add(skills.get(0));
        feature = AmplReplanControllerProxyTest.proxy.deleteSkillsOfFeatureByIdOfProjectById(skillsToDelete, feature.getId(), this.projectId);
        Assert.notNull(feature);
    ...
    @Test(timeout = 10000)
    public void testDeleteSkillsOfFeatureByIdOfProjectById_sd21064_add21405_add22817() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        ...
        List<Skill> skillsToDelete = new ArrayList<>();
        Skill o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21064_add21405__16 = skills.get(0);
        Skill o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21064_add21405_add22817__19 = skills.get(0);
        assertEquals("Java", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21064_add21405_add22817__19).getName());
        assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21064_add21405_add22817__19).getId())));
        assertEquals("Java Programming Language modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21064_add21405_add22817__19).getDescription());
        boolean o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21064__16 = skillsToDelete.add(skills.get(0));
        feature = AmplReplanControllerProxyTest.proxy.deleteSkillsOfFeatureByIdOfProjectById(skillsToDelete, feature.getId(), this.projectId);
        Assert.notNull(feature);
        Integer o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21064__22 = feature.getPriority();
    ...
    @Test(timeout = 10000)
    public void testDeleteSkillsOfFeatureByIdOfProjectById_sd21060_add21327_add22646() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        ...
        List<Skill> skillsToDelete = new ArrayList<>();
        Skill o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21060_add21327__16 = skills.get(0);
        Skill o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21060_add21327_add22646__19 = skills.get(0);
        assertEquals("Java", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21060_add21327_add22646__19).getName());
        assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21060_add21327_add22646__19).getId())));
        assertEquals("Java Programming Language modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21060_add21327_add22646__19).getDescription());
        boolean o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21060__16 = skillsToDelete.add(skills.get(0));
        feature = AmplReplanControllerProxyTest.proxy.deleteSkillsOfFeatureByIdOfProjectById(skillsToDelete, feature.getId(), this.projectId);
        Assert.notNull(feature);
        Integer o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21060__22 = feature.getCode();
    ...
    @Test(timeout = 10000)
    public void testDeleteSkillsOfFeatureByIdOfProjectById_sd21065_sd21449_add22605() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        ...
        Assert.notNull(feature);
        List<Skill> skillsToDelete = new ArrayList<>();
        Skill o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21065_sd21449_add22605__16 = skills.get(0);
        assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21065_sd21449_add22605__16).getId())));
        assertEquals("Java Programming Language modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21065_sd21449_add22605__16).getDescription());
        assertEquals("Java", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21065_sd21449_add22605__16).getName());
        boolean o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21065__16 = skillsToDelete.add(skills.get(0));
        feature = AmplReplanControllerProxyTest.proxy.deleteSkillsOfFeatureByIdOfProjectById(skillsToDelete, feature.getId(), this.projectId);
        Assert.notNull(feature);
        Integer o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21065__22 = feature.getReleaseId();
    ...
    @Test(timeout = 10000)
    public void testDeleteSkillsOfFeatureByIdOfProjectById_sd21065_sd21453_add22776() throws Exception {
        List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
        Assert.notNull(skills);
        Assert.notEmpty(skills);
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
        ...
        Assert.notNull(feature);
        List<Skill> skillsToDelete = new ArrayList<>();
        Skill o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21065_sd21453_add22776__16 = skills.get(0);
        assertEquals("Java Programming Language modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test modified by test", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21065_sd21453_add22776__16).getDescription());
        assertEquals("Java", ((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21065_sd21453_add22776__16).getName());
        assertEquals(1, ((int) (((eu.supersede.integration.api.replan.controller.types.Skill)o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21065_sd21453_add22776__16).getId())));
        boolean o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21065__16 = skillsToDelete.add(skills.get(0));
        feature = AmplReplanControllerProxyTest.proxy.deleteSkillsOfFeatureByIdOfProjectById(skillsToDelete, feature.getId(), this.projectId);
        Assert.notNull(feature);
        Integer o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21065__22 = feature.getReleaseId();
    ...
    @Test(timeout = 10000)
    public void testDeleteSkillsOfFeatureByIdOfProjectById_sd21064_add21405_sd22830_failAssert0() throws Exception {
        try {
            Date __DSPOT_deadline_1098 = new Date("Rc]5u=^+Op(XM{CFmTeG");
            List<Skill> skills = AmplReplanControllerProxyTest.proxy.getSkillsOfProjectById(this.projectId);
            Assert.notNull(skills);
            Assert.notEmpty(skills);
            List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(this.projectId);
            ...
            Assert.notNull(feature);
            Integer o_testDeleteSkillsOfFeatureByIdOfProjectById_sd21064__22 = feature.getPriority();
            feature.setDeadline(new Date("Rc]5u=^+Op(XM{CFmTeG"));
            org.junit.Assert.fail("testDeleteSkillsOfFeatureByIdOfProjectById_sd21064_add21405_sd22830 should have thrown IllegalArgumentException");
        } catch (IllegalArgumentException eee) {
        }
    }
    ...
    @Test(timeout = 10000)
    public void testGetFeatureByIdOfProjectById_sd23498() throws Exception {
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(projectId);
        Assert.notEmpty(features);
        Feature feature = AmplReplanControllerProxyTest.proxy.getFeatureByIdOfProjectById(features.get(0).getId(), projectId);
        Assert.notNull(feature);
        Integer o_testGetFeatureByIdOfProjectById_sd23498__9 = feature.getReleaseId();
        assertNull(o_testGetFeatureByIdOfProjectById_sd23498__9);
    }
    ...
    @Test(timeout = 10000)
    public void testGetFeatureByIdOfProjectById_sd23493_sd23626() throws Exception {
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(projectId);
        Assert.notEmpty(features);
        Feature feature = AmplReplanControllerProxyTest.proxy.getFeatureByIdOfProjectById(features.get(0).getId(), projectId);
        Assert.notNull(feature);
        ...
        assertNull(o_testGetFeatureByIdOfProjectById_sd23493_sd23626__13);
    }
    ...
    @Test(timeout = 10000)
    public void testGetFeatureByIdOfProjectById_sd23494_sd23652() throws Exception {
        List<Feature> features = AmplReplanControllerProxyTest.proxy.getFeaturesOfProjectById(projectId);
        Assert.notEmpty(features);
        Feature feature = AmplReplanControllerProxyTest.proxy.getFeatureByIdOfProjectById(features.get(0).getId(), projectId);
        Assert.notNull(feature);
        ...
        assertNull(o_testGetFeatureByIdOfProjectById_sd23494_sd23652__13);
    }
    ...
    @Test(timeout = 10000)
    public void testGetPlanOfReleaseByIdOfProjectById_sd25807() throws Exception {
        List<Release> releases = AmplReplanControllerProxyTest.proxy.getReleasesOfProjectById(projectId);
        Assert.notEmpty(releases);
        Plan plan = AmplReplanControllerProxyTest.proxy.getPlanOfReleaseByIdOfProjectById(releases.get(0).getId(), projectId);
        Assert.notNull(plan);
        Date o_testGetPlanOfReleaseByIdOfProjectById_sd25807__9 = plan.getCreationDate();
        assertEquals(1522252036920L, ((long) (((java.time.Instant)((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25807__9).toInstant()).toEpochMilli())));
        assertEquals(16, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25807__9).getSeconds())));
        assertEquals("28 Mar 2018 15:47:16 GMT", ((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25807__9).toGMTString());
        assertEquals(47, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25807__9).getMinutes())));
        assertEquals(17, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25807__9).getHours())));
        assertEquals(3, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25807__9).getDay())));
        assertEquals(-120, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25807__9).getTimezoneOffset())));
        assertEquals("Mar 28, 2018 5:47:16 PM", ((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25807__9).toLocaleString());
        assertEquals(1522252036L, ((long) (((java.time.Instant)((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25807__9).toInstant()).getEpochSecond())));
        assertEquals(118, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25807__9).getYear())));
        assertEquals(28, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25807__9).getDate())));
        assertEquals(920000000, ((int) (((java.time.Instant)((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25807__9).toInstant()).getNano())));
        assertEquals(2, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25807__9).getMonth())));
        assertEquals(1522252036920L, ((long) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25807__9).getTime())));
    }
    ...
    public void testGetPlanOfReleaseByIdOfProjectById_sd25810() throws Exception {
        ...
        Plan plan = AmplReplanControllerProxyTest.proxy.getPlanOfReleaseByIdOfProjectById(releases.get(0).getId(), projectId);
        Assert.notNull(plan);
        assertEquals(1, plan.getNumberJobs());
    }
    ...
    @Test(timeout = 10000)
    public void testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896() throws Exception {
        List<Release> releases = AmplReplanControllerProxyTest.proxy.getReleasesOfProjectById(projectId);
        Assert.notEmpty(releases);
        Integer o_testGetPlanOfReleaseByIdOfProjectById_add25804__4 = releases.get(0).getId();
        Plan plan = AmplReplanControllerProxyTest.proxy.getPlanOfReleaseByIdOfProjectById(releases.get(0).getId(), projectId);
        ...
        assertEquals("28 Mar 2018 15:47:16 GMT", ((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896__13).toGMTString());
        assertEquals(1522252036920L, ((long) (((java.time.Instant)((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896__13).toInstant()).toEpochMilli())));
        assertEquals(17, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896__13).getHours())));
        assertEquals(-120, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896__13).getTimezoneOffset())));
        assertEquals(3, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896__13).getDay())));
        assertEquals(920000000, ((int) (((java.time.Instant)((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896__13).toInstant()).getNano())));
        assertEquals(1522252036920L, ((long) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896__13).getTime())));
        assertEquals(1522252036L, ((long) (((java.time.Instant)((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896__13).toInstant()).getEpochSecond())));
        assertEquals(16, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896__13).getSeconds())));
        assertEquals(47, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896__13).getMinutes())));
        assertEquals(28, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896__13).getDate())));
        assertEquals("Mar 28, 2018 5:47:16 PM", ((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896__13).toLocaleString());
        assertEquals(2, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896__13).getMonth())));
        assertEquals(118, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896__13).getYear())));
    }
    ...
    @Test(timeout = 10000)
    public void testGetPlanOfReleaseByIdOfProjectById_sd25807_sd25927() throws Exception {
        List<Release> releases = AmplReplanControllerProxyTest.proxy.getReleasesOfProjectById(projectId);
        Assert.notEmpty(releases);
        Plan plan = AmplReplanControllerProxyTest.proxy.getPlanOfReleaseByIdOfProjectById(releases.get(0).getId(), projectId);
        Assert.notNull(plan);
    ...
    @Test(timeout = 10000)
    public void testGetPlanOfReleaseByIdOfProjectById_sd25807_sd25928() throws Exception {
        List<Release> releases = AmplReplanControllerProxyTest.proxy.getReleasesOfProjectById(projectId);
        Assert.notEmpty(releases);
        Plan plan = AmplReplanControllerProxyTest.proxy.getPlanOfReleaseByIdOfProjectById(releases.get(0).getId(), projectId);
        Assert.notNull(plan);
    ...
    @Test(timeout = 10000)
    public void testGetPlanOfReleaseByIdOfProjectById_sd25809_sd25949() throws Exception {
        List<Release> releases = AmplReplanControllerProxyTest.proxy.getReleasesOfProjectById(projectId);
        Assert.notEmpty(releases);
        Plan plan = AmplReplanControllerProxyTest.proxy.getPlanOfReleaseByIdOfProjectById(releases.get(0).getId(), projectId);
        Assert.notNull(plan);
        ...
        assertEquals(17, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25809_sd25949__13).getHours())));
        assertEquals(47, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25809_sd25949__13).getMinutes())));
        assertEquals(16, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25809_sd25949__13).getSeconds())));
        assertEquals("Mar 28, 2018 5:47:16 PM", ((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25809_sd25949__13).toLocaleString());
        assertEquals(28, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25809_sd25949__13).getDate())));
        assertEquals(1522252036920L, ((long) (((java.time.Instant)((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25809_sd25949__13).toInstant()).toEpochMilli())));
        assertEquals(920000000, ((int) (((java.time.Instant)((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25809_sd25949__13).toInstant()).getNano())));
        assertEquals(-120, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25809_sd25949__13).getTimezoneOffset())));
        assertEquals(2, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25809_sd25949__13).getMonth())));
        assertEquals(1522252036L, ((long) (((java.time.Instant)((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25809_sd25949__13).toInstant()).getEpochSecond())));
        assertEquals(3, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25809_sd25949__13).getDay())));
        assertEquals(118, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25809_sd25949__13).getYear())));
        assertEquals(1522252036920L, ((long) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25809_sd25949__13).getTime())));
        assertEquals("28 Mar 2018 15:47:16 GMT", ((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_sd25809_sd25949__13).toGMTString());
    }
    ...
    @Test(timeout = 10000)
    public void testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896_sd26588() throws Exception {
        List<Release> releases = AmplReplanControllerProxyTest.proxy.getReleasesOfProjectById(this.projectId);
        Assert.notEmpty(releases);
        Integer o_testGetPlanOfReleaseByIdOfProjectById_add25804__4 = releases.get(0).getId();
        Plan plan = AmplReplanControllerProxyTest.proxy.getPlanOfReleaseByIdOfProjectById(releases.get(0).getId(), this.projectId);
    ...
    @Test(timeout = 10000)
    public void testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896_add26585() throws Exception {
        List<Release> releases = AmplReplanControllerProxyTest.proxy.getReleasesOfProjectById(this.projectId);
        Assert.notEmpty(releases);
        Integer o_testGetPlanOfReleaseByIdOfProjectById_add25804__4 = releases.get(0).getId();
        Plan plan = AmplReplanControllerProxyTest.proxy.getPlanOfReleaseByIdOfProjectById(releases.get(0).getId(), this.projectId);
        Assert.notNull(plan);
        Date o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896_add26585__13 = plan.getCreationDate();
        assertEquals("Mar 28, 2018 5:47:16 PM", ((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896_add26585__13).toLocaleString());
        assertEquals(1522252036920L, ((long) (((java.time.Instant)((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896_add26585__13).toInstant()).toEpochMilli())));
        assertEquals(118, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896_add26585__13).getYear())));
        assertEquals(2, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896_add26585__13).getMonth())));
        assertEquals("28 Mar 2018 15:47:16 GMT", ((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896_add26585__13).toGMTString());
        assertEquals(16, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896_add26585__13).getSeconds())));
        assertEquals(1522252036920L, ((long) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896_add26585__13).getTime())));
        assertEquals(47, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896_add26585__13).getMinutes())));
        assertEquals(-120, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896_add26585__13).getTimezoneOffset())));
        assertEquals(3, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896_add26585__13).getDay())));
        assertEquals(920000000, ((int) (((java.time.Instant)((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896_add26585__13).toInstant()).getNano())));
        assertEquals(1522252036L, ((long) (((java.time.Instant)((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896_add26585__13).toInstant()).getEpochSecond())));
        assertEquals(28, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896_add26585__13).getDate())));
        assertEquals(17, ((int) (((java.util.Date)o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896_add26585__13).getHours())));
        Date o_testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896__13 = plan.getCreationDate();
    }

    @Test(timeout = 10000)
    public void testGetPlanOfReleaseByIdOfProjectById_add25804_sd25896_sd26589() throws Exception {
        List<Release> releases = AmplReplanControllerProxyTest.proxy.getReleasesOfProjectById(this.projectId);
        Assert.notEmpty(releases);
        Integer o_testGetPlanOfReleaseByIdOfProjectById_add25804__4 = releases.get(0).getId();
        Plan plan = AmplReplanControllerProxyTest.proxy.getPlanOfReleaseByIdOfProjectById(releases.get(0).getId(), this.projectId);
    ...
    @Test(timeout = 10000)
    public void testGetPlanOfReleaseByIdOfProjectById_sd25809_sd25949_sd26787() throws Exception {
        List<Release> releases = AmplReplanControllerProxyTest.proxy.getReleasesOfProjectById(this.projectId);
        Assert.notEmpty(releases);
        Plan plan = AmplReplanControllerProxyTest.proxy.getPlanOfReleaseByIdOfProjectById(releases.get(0).getId(), this.projectId);
        Assert.notNull(plan);
    ...
    @Test(timeout = 10000)
    public void testGetPlanOfReleaseByIdOfProjectById_sd25807_sd25928_sd26738() throws Exception {
        List<Release> releases = AmplReplanControllerProxyTest.proxy.getReleasesOfProjectById(this.projectId);
        Assert.notEmpty(releases);
        Plan plan = AmplReplanControllerProxyTest.proxy.getPlanOfReleaseByIdOfProjectById(releases.get(0).getId(), this.projectId);
        Assert.notNull(plan);
        Date o_testGetPlanOfReleaseByIdOfProjectById_sd25807__9 = plan.getCreationDate();
        Integer o_testGetPlanOfReleaseByIdOfProjectById_sd25807_sd25928__13 = plan.getNumberJobs();
        assertEquals(1, plan.getReleaseId());
    }
    ...
    @Test(timeout = 10000)
    public void testGetPlanOfReleaseByIdOfProjectById_sd25810_sd25977_sd26861() throws Exception {
        List<Release> releases = AmplReplanControllerProxyTest.proxy.getReleasesOfProjectById(this.projectId);
        Assert.notEmpty(releases);
        Plan plan = AmplReplanControllerProxyTest.proxy.getPlanOfReleaseByIdOfProjectById(releases.get(0).getId(), this.projectId);
        Assert.notNull(plan);
    ...
    public void testUpdateFeatureOfProjectById_sd28552() throws Exception {
        ...
        Assert.notNull(feature);
        assertEquals(111, AmplReplanControllerProxyTest.proxy.updateFeatureOfProjectById(feature, projectId).getCode());
    }
